...
interface ToonMaterialPropertiesProps {
  properties: any;
  onChange: (properties: any) => void;
}

export function ToonMaterialProperties({ properties, onChange }: ToonMaterialPropertiesProps) {
  ...
  return (
    <div className="space-y-4">
      <h4 className="text-sm font-medium text-white">Toon Material Properties</h4>
