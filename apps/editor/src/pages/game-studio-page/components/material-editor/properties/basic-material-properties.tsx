...
interface BasicMaterialPropertiesProps {
  properties: any;
  onChange: (properties: any) => void;
}

export function BasicMaterialProperties({ properties, onChange }: BasicMaterialPropertiesProps) {
  ...
  return (
    <div className="space-y-4">
      <h4 className="text-sm font-medium text-white">Basic Material Properties</h4>
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <select
            value={properties.side || 0}
            onChange={(e) => handlePropertyChange("side", parseInt(e.target.value))}
            className="w-full px-3 py-2 text-sm bg-gray-800 border border-gray-600 rounded-md text-white"
          >
            <option value={0}>Front Side</option>
