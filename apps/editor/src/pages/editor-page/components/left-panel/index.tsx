...
export function LeftPanel({ projectName }: LeftPanelProps) {
  const [activeTab, setActiveTab] = useState('Scenes');

  const tabs = [
    { name: 'Scenes', icon: ScenesIcon, content: <ScenesPanel projectName={projectName} /> },
  ...
  return (
    <div className="fixed left-4 top-32 bottom-4 w-80 z-10 bg-gray-900/40 backdrop-blur-md rounded-xl border border-gray-800/50 flex flex-col">
