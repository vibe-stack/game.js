...
// Game Editor Types
import { GameProject, SceneData, SceneEntity, AssetReference } from "@/types/project";
...
interface ProjectAPI {
  ...
  // Scene Management
  loadScene: (projectPath: string, sceneName: string) => Promise<SceneData>;
  saveScene: (projectPath: string, scene: SceneData) => Promise<void>;
  createScene: (projectPath: string, sceneName: string) => Promise<SceneData>;
